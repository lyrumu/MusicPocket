...
final List<_PlatformTarget> _platforms = [
  _PlatformTarget('网易云音乐', (q) => 'https://music.163.com/#/search/m/?s=${Uri.encodeQueryComponent(q)}'),
  _PlatformTarget('QQ音乐', (q) => 'https://y.qq.com/n/ryqq/search?w=${Uri.encodeQueryComponent(q)}'),
  _PlatformTarget('Apple Music', (q) => 'https://music.apple.com/cn/search?term=${Uri.encodeQueryComponent(q)}'),
  _PlatformTarget('Spotify', (q) => 'https://open.spotify.com/search/${Uri.encodeQueryComponent(q)}'),
];
        ...
        return ListView(
          ...
          children: [
            ...
            if (results.playlists.isNotEmpty) ...[
              ...
              ...results.playlists.map((p) => ListTile(
                    leading: CoverImage(
